...
function Navbar() {
  ...
  const handleLogout = () => {
    // No Firebase sign out, just navigate to home
    navigate('/');
    handleUserMenuClose();
  };
  ...
  const drawer = (
    <Box sx={{ mt: 2 }}>
      <List>
        ...
        {/* Remove user authentication logic, always show Login button */}
        ...
        <Toolbar disableGutters>
          ...
          {isMobile ? (
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              {/* Remove user avatar and authentication logic, always show Login button */}
              <Button
                color="primary"
